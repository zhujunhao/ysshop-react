...
export const getPopularKeywords = state => {
  return state.search.popularKeywords.ids.map(goodsNum => {
    return getKeywordById(state, goodsNum)
  })
}
...
export const getRelatedKeywords = state => {
  ...
  return relatedKeywords.ids.map(goodsNum => {
    return getKeywordById(state, goodsNum)
  })
}
...
export const getHistoryKeywords = state => {
  return state.search.historyKeywords.map(goodsNum => {
    return getKeywordById(state, goodsNum)
  })
}
...
export const getSearchedShops = state => {
  ...
  return shops.ids.map(goodsNum => {
    return getShopById(state, goodsNum);
  })
}
